...
#define kMainPageDistance   44   //打开左侧窗时，中视图(右视图)露出的宽度
#define kMainPageScale   1.f  //打开左侧窗时，中视图(右视图）缩放比例
...
#define vCouldChangeDeckStateDistance 1
#define vSpeedFloat   0.7    //滑动速度

#define kLeftAlpha 0.05  //左侧蒙版的最大值
#define kLeftCenterX 30 //左侧初始偏移量
#define kLeftScale 1.f //左侧初始缩放比例
...
@property (weak, nonatomic) id<LeftSlideViewControllerDelegate>  delegate;
